...
El dataset contiene un total de 12 variables.
...
Vemos que apenas hay variables con datos faltantes, pero una de las variables (*ZTLIBROP*) tiene uno de sus registros faltantes, vamos a tratar este caso con mas atención.
...
Vemos que la variable que mejor se correlaciona con *ZTLIBROP* es *ZESPVIDA*, de modo que vamos a hacer una prueba de homogeneidad de medias entre las dos poblaciones para discernir si los datos faltantes siguen un patrón no aleatorio
